...
$frontendPort = parse_url((string) env('FRONTEND_URL', ''), PHP_URL_PORT);
$frontendHostWithPort = $frontendHost
    ? ($frontendPort ? sprintf('%s:%d', $frontendHost, $frontendPort) : $frontendHost)
    : null;
